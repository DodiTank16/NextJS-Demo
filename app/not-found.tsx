        ...
        <div className="row">
          <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
            ...
            <Link href="/">
              <button
                type="button"
                className="bg-green-400 px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg cursor-pointer transition ease-in"
              >
                Go to Home
              </button>
            </Link>
